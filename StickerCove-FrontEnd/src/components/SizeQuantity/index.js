...
const SizeQuantity = ({
  ...
  const generateSize = (pSizes) =>
    pSizes.map((pSize, index) => (
      <div
        className="size-quantity-card-select-size-popular-item flex"
        key={index}
      >
        <label
        ...
        >
          ...
          <input
            ...
            defaultChecked={pSize[0] === size[0] && pSize[1] === size[1]}
          />
      ...
      >
        ...
        >
          ...
          <input
            ...
            defaultChecked={pQuantity === quantity}
          />
          <span className="checkmark"></span>
        </label>
        <span>{`$ ${getPriseOfSize(size, pQuantity)}`}</span>
      </div>
    ))
        ...
        <div className="size-quantity-card flex">
          ...
          <div className="size-quantity-card-select flex">
            ...
            <div className="size-quantity-card-select-quantity flex flex-column">
              ...
              <div
                className="size-quantity-card-next flex"
                onClick={handleNext}
              >
                Next
